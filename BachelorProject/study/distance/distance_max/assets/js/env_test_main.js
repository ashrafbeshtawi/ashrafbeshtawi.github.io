...
function finished(){
	name=$('#p_name').val();
	exFileName="task_2.csv";
	template=`
		<button class="btn btn-primary btn-lg active buttonCenteredResults" onclick="downloadCSV();">Download Results</button>
		&nbsp;&nbsp;&nbsp;
	 	<button class="btn btn-success btn-lg active buttonCenteredResults" style="display:none;" id="nextTask" onclick="window.location.href='../distance_recommended/index.html'">Next Task</button>`
