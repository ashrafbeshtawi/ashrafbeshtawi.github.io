...
function finished(){
	...
	template=`
		...
		&nbsp;&nbsp;&nbsp;
	 	<button class="btn btn-success btn-lg active buttonCenteredResults" style="display:none;" id="nextTask" onclick="window.location.href='../light_100/index.html'">Next Task</button>`
